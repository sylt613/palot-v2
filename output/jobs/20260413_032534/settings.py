...
# INPUT / OUTPUT
# ═══════════════════════════════════════════════════════════════════════════
DOCX_PATH       = "/root/Desktop/palot/version2/1-22 fixed.docx"
DOC_PARTS_PATH  = "/root/Desktop/palot/version2/doc_parts.json"
OUT_PDF         = "/root/Desktop/palot/version2/output/palaot_v2.pdf"
OUT_DIR         = "/root/Desktop/palot/version2/output"
...
# ═══════════════════════════════════════════════════════════════════════════
FONTS_DIR       = "/root/Desktop/palot/version2/fonts"
FIXED_FONTS_DIR = "/root/Desktop/palot/version2/fonts"

# Body font — FrankReal Regular
BODY_FONT_PATH  = "/root/Desktop/palot/version2/fonts/FrankReal_Reg.ttf"
BODY_FONT_NAME  = "frankreal"

# Heading font — Eft Tefilot Bold (all headings + title)
HEADING_FONT_PATH      = f"{FONTS_DIR}/EFT_Tefilot_Bold.ttf"
HEADING_FONT_NAME      = "efttefilotbold"
HEADING_FONT_REG_PATH  = f"{FONTS_DIR}/EFT_Tefilot.ttf"
HEADING_FONT_REG_NAME  = "efttefilot"

# Dropcap font — Eft Mesorah Bold (first word of each paragraph)
DROPCAP_FONT_PATH = f"{FONTS_DIR}/EFT_Mesora_Bold.ttf"
DROPCAP_FONT_NAME = "eftmesorabold"
...
# MG Aleh Zayis — used for sefer title in even-page header
EFT_TALPIYOT_FONT_PATH = f"{FONTS_DIR}/MG_Aleh_Zayis.ttf"
EFT_TALPIYOT_FONT_NAME = "mgalehzayis"

# Footnote font — reuse body font
FN_FONT_NAME    = "frankreal"
...
H1_TOP_GAP          = 30.0                   # extra space above anaf heading (pt)
...
H1_ORNAMENT_SIZE    = 15.0                   # size of label ornaments
H1_ORNAMENT_GAP     = 7                      # gap between ornament and label text
H1_ORNAMENT_COLOR   = (0.5, 0.5, 0.5)       # gray ornaments

# ── Heading 2 (in-column sub-heading) ──
H2_FONT_SIZE        = 14.0                   # same as body
H2_FONT_NAME        = "efttefilotbold"       # heading font (centered, bold-look)
...
TITLE_FONT_SIZE     = 25.0                   # title at top of first page
TITLE_FONT_NAME     = "efttefilotbold"
...
EVEN_HEADER_FONT    = "efttefilot"           # Eft Tefilot regular (not bold)
EVEN_HEADER_SIZE    = 14.0
EVEN_HEADER_POSITION = "inside"              # inside = spine side

# ── Odd page (recto) header: anaf label + name ──
ODD_HEADER_FONT_LABEL  = "livornabold"       # ענף label font (bold)
ODD_HEADER_FONT_NAME   = "livornaregular"    # anaf name font (regular)
