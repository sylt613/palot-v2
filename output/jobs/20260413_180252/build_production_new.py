...
def draw_running_header_odd_full(c, page_num, anaf_label, anaf_name):
    ...
    # Leader: continuous rule with a curled termination near the page number
...
def draw_running_header_even(c, page_num, anaf_label, anaf_name):
    ...
    # Shortened rule: strong near title (left/inside), fades toward page number (right/outside)
    rule_y = header_y - 1.2
