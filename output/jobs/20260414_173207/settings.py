...
# Heading font — EFT Besimches Bold / Regular (all headings + title)
HEADING_FONT_PATH      = "/data/fonts/Fonts (2) (5)/Fonts (2)/EFT_BESIMCHES BOLD.TTF"
HEADING_FONT_NAME      = "eftbesimchesbold"
HEADING_FONT_REG_PATH  = "/data/fonts/Fonts (2) (5)/Fonts (2)/EFT_BESIMCHES.TTF"
HEADING_FONT_REG_NAME  = "eftbesimches"

# Dropcap font — FrankReal Bold (first word of each paragraph)
DROPCAP_FONT_PATH = f"{FONTS_DIR}/FrankReal_Bold.ttf"
DROPCAP_FONT_NAME = "frankrealbold"
...
# Even-page header title font — EFT Besimches Bold
EFT_TALPIYOT_FONT_PATH = "/data/fonts/Fonts (2) (5)/Fonts (2)/EFT_BESIMCHES BOLD.TTF"
EFT_TALPIYOT_FONT_NAME = "eftbesimchesbold"
...
H2_FONT_NAME        = "eftbesimchesbold"     # heading font (centered, bold-look)
...
TITLE_FONT_NAME     = "eftbesimchesbold"
...
EVEN_HEADER_FONT    = "eftbesimches"         # EFT Besimches regular (not bold)
