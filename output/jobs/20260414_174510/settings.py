...
# Heading font — FrankReal Bold / Med (all headings + title)
HEADING_FONT_PATH      = f"{FONTS_DIR}/FrankReal_Bold.ttf"
HEADING_FONT_NAME      = "frankrealbold"
HEADING_FONT_REG_PATH  = f"{FONTS_DIR}/FrankReal_Med.ttf"
HEADING_FONT_REG_NAME  = "frankrealmed"
...
# Even-page header title font — FrankReal Bold
EFT_TALPIYOT_FONT_PATH = f"{FONTS_DIR}/FrankReal_Bold.ttf"
EFT_TALPIYOT_FONT_NAME = "frankrealbold"
...
H2_FONT_NAME        = "frankrealbold"        # heading font (centered, bold-look)
...
EVEN_HEADER_FONT    = "frankrealmed"         # FrankReal Med (not bold)
