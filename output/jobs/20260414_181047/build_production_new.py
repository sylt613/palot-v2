...
def _draw_anaf_flanker(c, x_center, y_center, width, gray=0.38, mirror=False, darken=None):
    accent_w = width * 0.62
    accent_y = y_center + width * 0.02
    if draw_png_ornament(c, _PNG_TOC_ENTRY_ACCENT, x_center, accent_y, width=accent_w, preserve_aspect=True, mirror=mirror, darken=darken):
        return
    h = width * 0.92
    top_y = y_center + h / 2
    bot_y = y_center - h / 2
