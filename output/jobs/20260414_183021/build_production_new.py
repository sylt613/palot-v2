...
def draw_generated_subhead_rule(c, x_center, y_center, width, mirror=False):
    png_path = _PNG_SUBHEAD_RULE_RIGHT if os.path.exists(_PNG_SUBHEAD_RULE_RIGHT) else _PNG_HEADER_LEADER_RIGHT
    return draw_png_ornament(c, png_path, x_center, y_center, width=width, preserve_aspect=True, mirror=mirror)
...
SUB_RULE_INSET = 2.0
SUB_RULE_TOP_PAD = 3.0
SUB_TEXT_TOP_PAD = 10.5
SUB_TEXT_BOTTOM_PAD = 7.5
