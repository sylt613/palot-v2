...
MIN_SUB_AFTER_GAP = PSEP * 0.5   # floor for balancer squeezing
MAX_SUB_AFTER_GAP = LH * 1.6     # ceiling for balancer stretching after sub
...
def draw_toc_page(c, anaf_entries, page_offset):
    ...
    mamar_y = title_orn_y - TOC_TITLE_FS * 5.1
    if MAMAR_NAME:
    ...
    rule_y = mamar_y - TOC_MAMAR_FS * 2.9
