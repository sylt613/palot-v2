...
def draw_running_header_odd_full(c, page_num, anaf_label, anaf_name):
    ...
    """
    header_y = C_TOP - 2
    rule_y = header_y  # band centered on baseline → bottom of band = baseline - render_h/2, top ≈ cap-height/2
...
def draw_running_header_even(c, page_num, anaf_label, anaf_name):
    ...
    rule_y = header_y  # band centered on baseline, matching odd header
