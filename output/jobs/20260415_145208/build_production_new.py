...
def draw_contact_page(c):
    ...
    # Anchor the strip pair: position the centre of the two-strip assembly at
    # 60% from C_LEFT (toward the right/outer side of the even page).
    pair_cx      = C_LEFT + C_W * 0.60
