...
def _apply_gray_halo(canvas):
    ...
    Works at whatever resolution canvas is.  Steps:
      1. Build binary ink mask (pixels < _INK_THRESHOLD).
      2. Gaussian-blur the mask → smooth falloff gradient.
      3. Where blurred mask > 0 AND pixel is NOT original ink AND pixel
