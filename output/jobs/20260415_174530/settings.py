...
# Dropcap font — EFT Pnina Medium (first word of each paragraph)
DROPCAP_FONT_PATH = f"{FONTS_DIR}/EFT_PNINA MEDIUM.TTF"
DROPCAP_FONT_NAME = "pninamedium"
...
# Even-page header title font — EFT Pnina Medium
...
def compute_derived():
    ...
    m.H2_SPACE_BEFORE_PT = m.H2_SPACE_BEFORE if m.H2_SPACE_BEFORE is not None else m.PSEP
