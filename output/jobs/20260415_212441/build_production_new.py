...
def draw_frame_box(c, x_left, y_bot, width_pt, height_pt, intensity=1.0, png_path=None):
    """Draw the baroque scroll frame at any size.
    If png_path is provided, use that pre-generated PNG directly (stretched to fit).
    Otherwise fall back to the tiled frame builder.
