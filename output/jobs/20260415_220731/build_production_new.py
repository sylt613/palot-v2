...
def _build_strip_frame(w_px, h_px, intensity=1.0):
    ...
    # Paste corners LAST so they sit on top of strip ends
    frame.paste(c_tl, (0, 0), c_tl)
    frame.paste(c_tr, (w_px - cs, 0), c_tr)
    frame.paste(c_bl, (0, h_px - cs), c_bl)
    frame.paste(c_br, (w_px - cs, h_px - cs), c_br)
