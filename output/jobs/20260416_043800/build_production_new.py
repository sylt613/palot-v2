...
def draw_toc_page(c, anaf_entries, page_offset):
    ...
    draw_frame_box(c, title_frame_left, title_frame_bot, title_frame_w, title_frame_h, intensity=0.35,
    ...
    if MAMAR_NAME:
        ...
        draw_generated_subhead_rule(c, mamar_cx, top_rule_y, mamar_rule_w,
                                    mirror=False, flip_vertical=False, intensity=0.35)
        ...
        draw_generated_subhead_rule(c, mamar_cx, bot_rule_y, mamar_rule_w,
                                    mirror=True, flip_vertical=True, intensity=0.35)
...
def draw_section_header(c, text, y, kind='section'):
    ...
    if kind == 'sefer_title':
        ...
        # Draw frame FIRST, then text on top so text is never obscured
        draw_frame_box(c, frame_left, frame_bot, frame_bw, frame_bh, intensity=0.35,
