...
def draw_toc_page(c, anaf_entries, page_offset):
    ...
    for label_str, name_str, pg in anaf_entries:
        ...
        # Dot leaders: fixed start (just right of widest page number) → just left of this row's name
        row_first_w = _first_line_w(name_v)
        dot_start = common_dot_start
        dot_end   = name_right_x - row_first_w - dot_w * 2
        dot_x = dot_start
