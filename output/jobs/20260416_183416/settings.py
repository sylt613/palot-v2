...
# Body font — EFT Bazelet
BODY_FONT_PATH  = os.path.join(BASE_DIR, "fonts", "EFT_BAZELET.TTF")
BODY_FONT_NAME  = "eftbazelet"
...
# Dropcap font — EFT Bazelet Bold (first word, slightly bigger)
DROPCAP_FONT_PATH = f"{FONTS_DIR}/EFT_BAZELET BOLD.TTF"
DROPCAP_FONT_NAME = "eftbazeletbold"
...
# Bold body font — EFT Bazelet Bold (used for bold runs in body text)
BOLD_BODY_FONT_PATH = f"{FONTS_DIR}/EFT_BAZELET BOLD.TTF"
BOLD_BODY_FONT_NAME = "eftbazeletbold"
...
H1_ORNAMENT_GAP     = 2                      # gap between ornament and label text
