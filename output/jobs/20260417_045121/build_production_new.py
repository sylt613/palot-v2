...
def render_mamar_box_image(width_pt, height_pt, dpi=300,
    ...
    if natural is not None:
        # Use the BOTTOMMOST long-ink-run row — this is the OUTER edge of the
        # thick main horizontal ink block (rows 95–99 in a 100px band). Placing
        # this row at the box edge line makes the ornament's thick line sit
        # FLUSH against the box edge with curls extending outward.
        ...
        for edge_side, edge_y_px in (('top', box_t), ('bot', box_b)):
            ...
            #   TOP edge of box  → natural      (curls extend UP, OUTSIDE box)
            #   BOT edge of box  → flipped T⇅B  (curls extend DOWN, OUTSIDE box)
            if edge_side == 'top':
                band = natural
