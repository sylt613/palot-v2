...
_MB_CORNER_W_SRC = 80    # width of corner cap pieces (left/right)
_MB_SIDE_W_SRC   = 60    # width of side (left/right) strips
_MB_TILE_COL     = 150   # source column for 1-px top/bottom tile slice
_MB_SIDE_ROW     = 400   # source row for 1-px side tile slice
