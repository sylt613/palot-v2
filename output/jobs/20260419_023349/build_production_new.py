...
_MB_CAP_X1_SRC = 54
# Preserve the full ornament shoulders, not just the dark core. Measured with
# a looser threshold on rows above the top rail, the visible ornament extent is
# about x=98..839 in source pixels.
_MB_CAP_X2_SRC = 98
_MB_CAP_X3_SRC = 839
_MB_CAP_X4_SRC = 889
_MB_CAP_SAMPLE_L_SRC = 76
_MB_CAP_SAMPLE_R_SRC = 861
