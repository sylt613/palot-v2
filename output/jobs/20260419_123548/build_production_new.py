...
def _build_tiled_mamar_box_image(target_w_px, target_h_px, orn_h_px=83):
    ...
    # Aspect-locked scale to the target box. Do not additionally cap by
    # ornament height; that extra shrink was collapsing the side-wall
    # double-lines before PDF rendering.
