...
def draw_post_anaf_divider_band(c, x_center, y_top, width):
    ...
    if cached is None:
        ...
        try:
            ...
            # Build masks from ornament alpha.
            alpha_mask = src.getchannel('A')
            # Small white dilation: slightly thickens the ornament body.
            white_mask = alpha_mask.filter(ImageFilter.MaxFilter(3))
            # Larger gray dilation: forms the outer glow field.
            gray_mask  = alpha_mask.filter(ImageFilter.MaxFilter(7))
            ...
            gray_ring = gray_ring.filter(ImageFilter.GaussianBlur(2.2))
            ...
            gray_fill = Image.new('RGBA', (new_w, band_h_px), (145, 145, 145, 255))
            rgba.paste(gray_fill, (paste_x, pad_v_px), gray_ring)
            # Thick white ornament body.
            white_fill = Image.new('RGBA', (new_w, band_h_px), (252, 252, 252, 255))
            rgba.paste(white_fill, (paste_x, pad_v_px), white_mask)
