...
def draw_toc_page(c, anaf_entries, page_offset):
    ...
    frame_pad_x  = 22.0 * _MAMAR_BOX_SIZE_MULT
    orn_h_pt     = 13.0 * _MAMAR_BOX_SIZE_MULT   # decorative scrollwork height
    frame_pad_y  = 10.0 * _MAMAR_BOX_SIZE_MULT   # inner padding top & bottom inside box rectangle
...
def draw_section_header(c, text, y, kind='section'):
    ...
    if kind == 'sefer_title':
        ...
        frame_pad_x = 30.0 * _MAMAR_BOX_SIZE_MULT
        orn_h_pt    = 13.0 * _MAMAR_BOX_SIZE_MULT   # decorative scrollwork height (≈1 line)
        frame_pad_y = 10.0 * _MAMAR_BOX_SIZE_MULT   # inner padding top & bottom inside box rectangle
