...
_MB_ROOT_SCALE_MAX    = 1.10
_MB_ROOT_SCALE_BOOST  = 1.10
...
def draw_toc_page(c, anaf_entries, page_offset):
    ...
    frame_pad_x  = 22.0
    # Alt frame ornament is proportionally taller (sy0≈41% of frame height)
    orn_h_pt     = 35.0 if _MAMAR_BOX_VARIANT == 'alt' else 13.0
    frame_pad_y  = 16.0   # inner padding top & bottom inside box rectangle
