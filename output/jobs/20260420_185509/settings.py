...
BODY_FONT_NAME  = "eft_bazelet"

# Heading font — EFT Pnina Medium / Regular (all headings + title)
HEADING_FONT_PATH      = os.path.join(BASE_DIR, "fonts", "EFT_BAZELET BOLD.TTF")
HEADING_FONT_NAME      = "eft_bazeletbold"
HEADING_FONT_REG_PATH  = os.path.join(BASE_DIR, "fonts", "EFT_BAZELET.TTF")
HEADING_FONT_REG_NAME  = "eft_bazelet"
...
BOLD_BODY_FONT_PATH = os.path.join(BASE_DIR, "fonts", "EFT_BAZELET BOLD.TTF")
BOLD_BODY_FONT_NAME = "eft_bazeletbold"
