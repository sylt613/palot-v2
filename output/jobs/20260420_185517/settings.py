...
BODY_FONT_PATH  = os.path.join(BASE_DIR, "fonts", "EFT_CHAMOMILE LIGHT.TTF")
BODY_FONT_NAME  = "eft_chamomilelight"

# Heading font — EFT Pnina Medium / Regular (all headings + title)
HEADING_FONT_PATH      = os.path.join(BASE_DIR, "fonts", "EFT_CHAMOMILE BOLD.TTF")
HEADING_FONT_NAME      = "eft_chamomilebold"
HEADING_FONT_REG_PATH  = os.path.join(BASE_DIR, "fonts", "EFT_CHAMOMILE.TTF")
HEADING_FONT_REG_NAME  = "eft_chamomile"
...
BOLD_BODY_FONT_PATH = os.path.join(BASE_DIR, "fonts", "EFT_CHAMOMILE BOLD.TTF")
BOLD_BODY_FONT_NAME = "eft_chamomilebold"
