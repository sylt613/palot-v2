...
BODY_FONT_PATH  = os.path.join(BASE_DIR, "fonts", "EFT_CRYSTAL LIGHT.TTF")
BODY_FONT_NAME  = "eft_crystallight"

# Heading font — EFT Pnina Medium / Regular (all headings + title)
HEADING_FONT_PATH      = os.path.join(BASE_DIR, "fonts", "EFT_CRYSTAL BOLD.TTF")
HEADING_FONT_NAME      = "eft_crystalbold"
HEADING_FONT_REG_PATH  = os.path.join(BASE_DIR, "fonts", "EFT_CRYSTAL.TTF")
HEADING_FONT_REG_NAME  = "eft_crystal"
...
BOLD_BODY_FONT_PATH = os.path.join(BASE_DIR, "fonts", "EFT_CRYSTAL BOLD.TTF")
BOLD_BODY_FONT_NAME = "eft_crystalbold"
