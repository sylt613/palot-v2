...
BODY_FONT_PATH  = os.path.join(BASE_DIR, "fonts", "EFT_HEBREW LIGHT.TTF")
BODY_FONT_NAME  = "eft_hebrewlight"

# Heading font — EFT Pnina Medium / Regular (all headings + title)
HEADING_FONT_PATH      = os.path.join(BASE_DIR, "fonts", "EFT_HEBREW BOLD.TTF")
HEADING_FONT_NAME      = "eft_hebrewbold"
HEADING_FONT_REG_PATH  = os.path.join(BASE_DIR, "fonts", "EFT_HEBREW.TTF")
HEADING_FONT_REG_NAME  = "eft_hebrew"
...
BOLD_BODY_FONT_PATH = os.path.join(BASE_DIR, "fonts", "EFT_HEBREW BOLD.TTF")
BOLD_BODY_FONT_NAME = "eft_hebrewbold"
