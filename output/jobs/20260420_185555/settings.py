...
BODY_FONT_PATH  = os.path.join(BASE_DIR, "fonts", "Pauls Celtic Font 1.ttf")
BODY_FONT_NAME  = "paulscelticfont1"

# Heading font — EFT Pnina Medium / Regular (all headings + title)
HEADING_FONT_PATH      = os.path.join(BASE_DIR, "fonts", "Pauls Celtic Font 1.ttf")
HEADING_FONT_NAME      = "paulscelticfont1"
HEADING_FONT_REG_PATH  = os.path.join(BASE_DIR, "fonts", "Pauls Celtic Font 1.ttf")
HEADING_FONT_REG_NAME  = "paulscelticfont1"
...
BOLD_BODY_FONT_PATH = os.path.join(BASE_DIR, "fonts", "Pauls Celtic Font 1.ttf")
BOLD_BODY_FONT_NAME = "paulscelticfont1"
