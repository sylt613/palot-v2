...
BODY_FONT_PATH  = os.path.join(BASE_DIR, "fonts", "EFT_PEGASUS LIGHT.TTF")
BODY_FONT_NAME  = "eft_pegasuslight"

# Heading font — EFT Pnina Medium / Regular (all headings + title)
HEADING_FONT_PATH      = os.path.join(BASE_DIR, "fonts", "EFT_PEGASUS BOLD.TTF")
HEADING_FONT_NAME      = "eft_pegasusbold"
HEADING_FONT_REG_PATH  = os.path.join(BASE_DIR, "fonts", "EFT_PEGASUS.TTF")
HEADING_FONT_REG_NAME  = "eft_pegasus"
...
BOLD_BODY_FONT_PATH = os.path.join(BASE_DIR, "fonts", "EFT_PEGASUS BOLD.TTF")
BOLD_BODY_FONT_NAME = "eft_pegasusbold"
