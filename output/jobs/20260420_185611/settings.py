...
BODY_FONT_PATH  = os.path.join(BASE_DIR, "fonts", "MAGNETOB (2).TTF")
BODY_FONT_NAME  = "magnetob2"

# Heading font — EFT Pnina Medium / Regular (all headings + title)
HEADING_FONT_PATH      = os.path.join(BASE_DIR, "fonts", "MAGNETOB (2).TTF")
HEADING_FONT_NAME      = "magnetob2"
HEADING_FONT_REG_PATH  = os.path.join(BASE_DIR, "fonts", "MAGNETOB (2).TTF")
HEADING_FONT_REG_NAME  = "magnetob2"
...
BOLD_BODY_FONT_PATH = os.path.join(BASE_DIR, "fonts", "MAGNETOB (2).TTF")
BOLD_BODY_FONT_NAME = "magnetob2"
