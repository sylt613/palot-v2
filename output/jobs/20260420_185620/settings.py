...
BODY_FONT_PATH  = os.path.join(BASE_DIR, "fonts", "MG Aleh Zayis.ttf")
BODY_FONT_NAME  = "mgalehzayis"

# Heading font — EFT Pnina Medium / Regular (all headings + title)
HEADING_FONT_PATH      = os.path.join(BASE_DIR, "fonts", "MG_Aleh_Zayis.ttf")
HEADING_FONT_NAME      = "mg_aleh_zayis"
HEADING_FONT_REG_PATH  = os.path.join(BASE_DIR, "fonts", "MG Aleh Zayis.ttf")
HEADING_FONT_REG_NAME  = "mgalehzayis"
...
BOLD_BODY_FONT_PATH = os.path.join(BASE_DIR, "fonts", "MG_Aleh_Zayis.ttf")
BOLD_BODY_FONT_NAME = "mg_aleh_zayis"
