...
BODY_FONT_PATH  = os.path.join(BASE_DIR, "fonts", "TOLM.TTF")
BODY_FONT_NAME  = "tolm"

# Heading font — EFT Pnina Medium / Regular (all headings + title)
HEADING_FONT_PATH      = os.path.join(BASE_DIR, "fonts", "TOLB.TTF")
HEADING_FONT_NAME      = "tolb"
HEADING_FONT_REG_PATH  = os.path.join(BASE_DIR, "fonts", "TOLM.TTF")
HEADING_FONT_REG_NAME  = "tolm"
...
BOLD_BODY_FONT_PATH = os.path.join(BASE_DIR, "fonts", "TOLB.TTF")
BOLD_BODY_FONT_NAME = "tolb"
