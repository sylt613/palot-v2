...
BODY_FONT_NAME  = "tehilaregular"

# Heading font — EFT Pnina Medium / Regular (all headings + title)
HEADING_FONT_PATH      = os.path.join(BASE_DIR, "fonts", "tehilamedium.ttf")
HEADING_FONT_NAME      = "tehilamedium"
HEADING_FONT_REG_PATH  = os.path.join(BASE_DIR, "fonts", "tehilaregular.ttf")
HEADING_FONT_REG_NAME  = "tehilaregular"
...
BOLD_BODY_FONT_PATH = os.path.join(BASE_DIR, "fonts", "tehilamedium.ttf")
BOLD_BODY_FONT_NAME = "tehilamedium"
