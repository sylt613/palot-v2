...
BODY_FONT_PATH  = os.path.join(BASE_DIR, "fonts", "DFrank.ttf")
BODY_FONT_NAME  = "dfrank"

# Heading font — EFT Pnina Medium / Regular (all headings + title)
HEADING_FONT_PATH      = os.path.join(BASE_DIR, "fonts", "DFrankB.ttf")
HEADING_FONT_NAME      = "dfrankb"
HEADING_FONT_REG_PATH  = os.path.join(BASE_DIR, "fonts", "DFrank.ttf")
HEADING_FONT_REG_NAME  = "dfrank"
...
BOLD_BODY_FONT_PATH = os.path.join(BASE_DIR, "fonts", "DFrankB.ttf")
BOLD_BODY_FONT_NAME = "dfrankb"
