...
BODY_FONT_PATH  = os.path.join(BASE_DIR, "fonts", "EFT_FRANKFURT.TTF")
BODY_FONT_NAME  = "eft_frankfurt"

# Heading font — EFT Pnina Medium / Regular (all headings + title)
HEADING_FONT_PATH      = os.path.join(BASE_DIR, "fonts", "EFT_FRANKFURT BOLD.TTF")
HEADING_FONT_NAME      = "eft_frankfurtbold"
HEADING_FONT_REG_PATH  = os.path.join(BASE_DIR, "fonts", "EFT_FRANKFURT.TTF")
HEADING_FONT_REG_NAME  = "eft_frankfurt"
...
BOLD_BODY_FONT_PATH = os.path.join(BASE_DIR, "fonts", "EFT_FRANKFURT BOLD.TTF")
BOLD_BODY_FONT_NAME = "eft_frankfurtbold"
