...
MAMAR_BOX_HALO_NEAR_DIL   = 4           # px: inner dilation (fills hairline gaps, grows white zone)
MAMAR_BOX_HALO_FAR_BLUR   = 6           # px: outer blur radius for gray fade
MAMAR_BOX_HALO_WHITE_VAL  = 252         # interior fill value (0-255)
MAMAR_BOX_HALO_GRAY_VAL   = 130         # outer halo gray value (0-255; higher = lighter)
MAMAR_BOX_HALO_FADE_STRENGTH = 0.55     # 0..1 — how prominent the outer gray halo is
