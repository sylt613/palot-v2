...
MAMAR_BOX_HALO_NEAR_DIL   = 14          # px: white-band thickness (grows pure white outward from ink)
MAMAR_BOX_HALO_FAR_BLUR   = 10          # px: extra reach of faded gray halo beyond the white band
MAMAR_BOX_HALO_WHITE_VAL  = 255         # pure-white band value (0-255)
MAMAR_BOX_HALO_GRAY_VAL   = 180         # outer halo gray value (higher = lighter / more subtle)
MAMAR_BOX_HALO_FADE_STRENGTH = 0.45     # 0..1 — peak opacity of the outer gray halo
