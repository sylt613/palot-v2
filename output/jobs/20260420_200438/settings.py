...
# Dropcap / first-word font — use the body Tehila registration exactly
DROPCAP_FONT_PATH = BODY_FONT_PATH
DROPCAP_FONT_NAME = BODY_FONT_NAME
...
MAMAR_BOX_HALO_FAR_BLUR   = 2.2         # px: soft fade on the gray outer ring only
MAMAR_BOX_HALO_WHITE_VAL  = 255         # pure-white band value (0-255)
MAMAR_BOX_HALO_GRAY_VAL   = 150         # outer ring gray value (higher = lighter / more subtle)
MAMAR_BOX_HALO_FADE_STRENGTH = 0.9      # 0..1 — peak opacity of the gray ring before fade
