...
# Body font — Tehila Regular (full Tehila build)
BODY_FONT_PATH  = os.path.join(BASE_DIR, "fonts", "tehilaregular.ttf")
BODY_FONT_NAME  = "1carizma"

# Heading font — Tehila Medium / Regular (all headings + title)
HEADING_FONT_PATH      = f"{FONTS_DIR}/tehilamedium.ttf"
HEADING_FONT_NAME      = "pninamedium"
HEADING_FONT_REG_PATH  = f"{FONTS_DIR}/tehilaregular.ttf"
HEADING_FONT_REG_NAME  = "pninaregular"

# Dropcap / first-word font — use the same medium Tehila face as subheadings
DROPCAP_FONT_PATH = HEADING_FONT_PATH
DROPCAP_FONT_NAME = HEADING_FONT_NAME
...
# Bold body font — Tehila Medium (no true bold available → medium stands in)
BOLD_BODY_FONT_PATH = f"{FONTS_DIR}/tehilamedium.ttf"
BOLD_BODY_FONT_NAME = "1carizmabold"

# Even-page header title font — Tehila Medium
EFT_TALPIYOT_FONT_PATH = f"{FONTS_DIR}/tehilamedium.ttf"
...
MAMAR_BOX_HALO_NEAR_DIL   = 3           # px: white-line thickness growth
MAMAR_BOX_HALO_RING_DIL   = 11          # px: extra outward growth for the gray ring
MAMAR_BOX_HALO_FAR_BLUR   = 1.2         # px: only a slight fade on the gray outer ring
MAMAR_BOX_HALO_WHITE_VAL  = 255         # pure-white band value (0-255)
MAMAR_BOX_HALO_GRAY_VAL   = 142         # outer ring gray value (higher = lighter / more subtle)
MAMAR_BOX_HALO_FADE_STRENGTH = 1.0      # 0..1 — peak opacity of the gray ring before fade
