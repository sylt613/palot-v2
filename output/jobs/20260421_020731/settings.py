...
LINE_HEIGHT_MULT    = 1.35  # line height multiplier (tighter)
...
MAMAR_BOX_HALO_NEAR_DIL   = 18          # px: white-line thickness growth (covers all source ink)
MAMAR_BOX_HALO_RING_DIL   = 32          # px: extra outward growth for the gray ring
MAMAR_BOX_HALO_FAR_BLUR   = 9.0         # px: soft glow fade matching post-anaf style
